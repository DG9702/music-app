export const SONG_RECENT_STORAGE = JSON.parse(localStorage.getItem('songRecent'));
export const CURRENT_TIME_STORAGE = JSON.parse(localStorage.getItem('currentTime'));
export const CURRENT_ID_STORAGE = JSON.parse(localStorage.getItem('currentIndex'));
export const VOLUME_STORAGE = JSON.parse(localStorage.getItem('current_Volume'));
