...
export const isMenuHeaderSelector = (state) => state.status.isMenuHeader;
export const isControlMusicMobileSelector = (state) => state.status.isControlMusicMobile;
export const isModalPlaylistSelector = (state) => state.status.isModalPlaylist;
//feature
...
export const combinedStatusSelector = createSelector(
    ...
    isMenuHeaderSelector,
    isControlMusicMobileSelector,
    isModalPlaylistSelector,
    (
        isPlaying,
        isRepeat,
        isRandom,
